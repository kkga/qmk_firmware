...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* LOWER
   ...
   '--------------------------+--------+--------+--------|        |-----------------+--------+--------+--------+--------'
                              ...
                              '--------+--------+--------|        |--------+--------+--------'
                                       ...
                                       '--------+--------'        '--------+--------'                                   */
  [_LWR] = LAYOUT(
    _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,          KC_CIRC, KC_AMPR, KC_ASTR, KC_UNDS, KC_EXLM, _______,
    _______, KC_LCBR, KC_EXLM, KC_AT,   KC_PIPE, KC_RCBR,	       KC_MINS, KC_7,    KC_8,    KC_9,    KC_PLUS, _______,
    _______, KC_LPRN, KC_HASH, KC_DLR,  KC_GRV,  KC_RPRN,          KC_ASTR, KC_4,    KC_5,    KC_6,    KC_EQL,  _______,
    _______, KC_LBRC, KC_PERC, KC_CIRC, KC_TILD, KC_RBRC,          KC_0,    KC_1,    KC_2,    KC_3,    KC_SLSH, _______,
  ...
  /* RAISE
   ...
   |--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------|
   |        |  BRI-  |  PREV  |  PLAY  |  NEXT  |  BRI+  |        |  HOME  | PG_DN  | PG_UP  |  END   |        |  F12   |
   |--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------|
   |        |        |  VOL-  |  MUTE  |  VOL+  |        |        |  LEFT  |  DOWN  |   UP   | RIGHT  |        |  INS   |
   |--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+--------|
   |        |  BACK  |   M1   |   M3   |   M2   |  FWD   |        |        |        |        |        |        |  DEL   |
   '--------------------------+--------+--------+--------|        |-----------------+--------+--------+--------+--------'
                              |        |        |        |        |        |        |        |
                              '--------+--------+--------|        |--------+--------+--------'
                                       |        | ADJUST |        | ADJUST |        |
  ...
  [_RSE] = LAYOUT(
    ...
    _______, KC_BRID, KC_MPRV, KC_MPLY, KC_MNXT, KC_BRIU,          KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, KC_F12,
    _______, _______, KC_VOLD, KC_MUTE, KC_VOLU, _______,          KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_INS,
    _______, KC_WBAK, KC_BTN1, KC_BTN3, KC_BTN2, KC_WFWD,          _______, _______, _______, _______, _______, KC_DEL,
                               _______, _______, _______,          _______, _______, _______,
