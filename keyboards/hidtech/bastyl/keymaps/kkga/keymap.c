...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWR] = LAYOUT(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS,
                               RSE_ESC, KC_SPC,  CTL_TAB,          KC_BSPC, KC_ENT,  LOWER,
                                        KC_LGUI, OSM_SFT,          KC_RALT, KC_RALT
  ),
  [_LWR] = LAYOUT(
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,          KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______,
    _______, KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_GRV, 	       KC_MINS, KC_7,    KC_8,    KC_9,    KC_UNDS, _______,
    _______, KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_TILD,          KC_PLUS, KC_4,    KC_5,    KC_6,    KC_EQL,  _______,
  ...
  [_RSE] = LAYOUT(
    ...
    _______, KC_BRIU, KC_VOLD, KC_MUTE, KC_VOLU, _______,          UNDO,    CUT,     COPY,    PASTE,   REDO,    KC_F12,
