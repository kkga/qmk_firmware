...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LWR] = LAYOUT(
    ...
    _______, KC_LBRC, KC_HOME, _______, KC_END,  KC_RBRC,          KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_QUES, _______,
  ...
  [_RSE] = LAYOUT(
    ...
    _______, KC_BRID, KC_MPRV, KC_MPLY, KC_MNXT, KC_BRIU,          _______, _______, _______, _______, _______, KC_F12,
    _______, _______, KC_VOLD, KC_MUTE, KC_VOLU, _______,          _______, _______, _______, _______, _______, KC_INS,
    _______, UNDO,    CUT,     COPY,    PASTE,   REDO,             _______, _______, _______, _______, _______, KC_DEL,
                               _______, _______, _______,          _______, _______, _______,
